let users = {
  sarahedo: {
    id: 'sarahedo',
    name: 'Sarah Edo',
    avatarURL: 'https://api.adorable.io/avatars/285/abott@sarahedo.png',
    answers: {
  ...
  tylermcginnis: {
    id: 'tylermcginnis',
    name: 'Tyler McGinnis',
    avatarURL: 'https://api.adorable.io/avatars/285/abott@tyler.png',
    answers: {
  ...
  johndoe: {
    id: 'johndoe',
    name: 'John Doe',
    avatarURL: 'https://api.adorable.io/avatars/285/abott@hohndoe.png',
    answers: {
